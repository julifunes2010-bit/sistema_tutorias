<template>
  <div class="forgot-container">
    <div class="forgot-box">
      ...
      <p class="subtitle">
        Ingresá tu correo institucional y te enviaremos un código de recuperación.
      </p>
      ...
      <button class="back-button" type="button" @click="volverLogin">
...
.forgot-container {
  ...
  padding: 30px;
  background:
    radial-gradient(circle at 50% 0%, #18243d 0%, #090d18 45%, #020308 100%);
...
.forgot-box {
  ...
  box-shadow:
    ...
    inset 0 0 25px rgba(0, 247, 255, 0.05);
}
...
input:focus {
  outline: none;
  border-color: #00f7ff;
  box-shadow: 0 0 5px #00f7ff, 0 0 15px rgba(0, 247, 255, 0.5);
}
